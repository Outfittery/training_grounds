...
class _DbarItem:
    def __init__(self):
        ...
        self.solid_bar_min = 0
        self.solid_bar_max = 0
        self.transparent_bar_min = 0
        self.transparent_bar_max = 0
    ...
    def finalize(self, value_format, color_indices, group_indices):
        ...
        if self.error is None:
            ...
            mn = self.value - self.error
            mx = self.value + self.error

            if mn > 0:
                self.solid_bar_min = 0
                self.solid_bar_max = mx
                self.transparent_bar_min = 0
                self.transparent_bar_max = mn
            elif mx < 0:
                self.solid_bar_min = mn
                self.solid_bar_max = 0
                self.transparent_bar_min = mx
                self.transparent_bar_max = 0
            else:
                self.solid_bar_max = mx
                self.solid_bar_min = mn
